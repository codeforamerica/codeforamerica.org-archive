<?php include_once('../_includes/head.php'); 
    $pageTitle = 'Why I\'m mentoring for America, by Zachary Townsend'; 
    $mastheadImage = 'masthead-6';
    $postTags = array('Accelerator', 'Commentary', 'Guest Post', 'Mentor');
?>
...
<div class="layout-semibreve">
    ...
    <article role="article">
        ...
        <header class="post-header isolate">
            ...
            <time class="post-date insulate text-whisper" datetime="2013-11-01T20:00+00:00">November 1st 2013</time>
        </header>
...
<?php include_once('../../_includes/blocks/patterns/nav-articles.html'); ?>
