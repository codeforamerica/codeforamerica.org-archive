...
<div class="masthead masthead-xl">
    <header class="layout-semibreve masthead-header">
        <h1 class="page-title" style="letter-spacing: normal; margin-top: 80px; line-height: 60px; font-size: 45px;">Government can work for the people, by the people, in the 21<sup>st</sup> century.</h1>
        
        <a href="#" class="button-invert" style="font-size: 18px;">Let’s make it work.</a>
