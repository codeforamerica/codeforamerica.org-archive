<!-- Based on Paul Lloyd's Barebones: http://barebones.paulrobertlloyd.com/ -->
    ...
    foreach($ffs as $ff) {
        if($ff != '.' && $ff != '..') {
            ...
            if(is_dir($dir.'/'.$ff)) { // If main section
                ...
                if(pathinfo($ff,PATHINFO_EXTENSION) == 'html' && $ff != 'foot.html' && $ff != 'head.html') { // Skip non-HTML files
                    echo "<div class=\"pattern\" id=\"".$fName."\">\n";
