...
class TestApache (unittest.TestCase):
    ...
    def test_redirects(self):
        ...
        '''
        pairs = [('/accelerator', '/companies/icubator-accelerator/'),
                 ('/incubator', '/companies/icubator-accelerator/'),
               ...
               # ('/fellows', '/about/fellowship/'),
                 ...
                 ('/accelerator', '/companies/icubator-accelerator/'),
                 ('/accelerator-2013', '/companies/icubator-accelerator/'),
                 ('/accelerator-2', '/companies/icubator-accelerator/'),
                 ('/startups/accelerator', '/companies/icubator-accelerator/'),
                 ('/incubator', '/companies/icubator-accelerator/'),
                 ('/incubator-2', '/companies/icubator-accelerator/'),
                 ('/startups/incubator-2', '/companies/icubator-accelerator/'),
                 ...
                 ('/geeks/our-startups', '/companies/icubator-accelerator/'),
                 ('/geeks/accelerator-faq', '/companies/icubator-accelerator/'),
                 ('/geeks/accelerator-apply', '/companies/icubator-accelerator/'),
